                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="d-flex justify-content-evenly">
                          <a href="/admin/database/agentes/edit/${data}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
    ...
    $('body').on('click', '.btn-danger', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax(
                    {
                        url: window.location.origin + "/api/agentes/" + id,
                        type: 'POST',
                        data: {
                            "id": id,
                            "_token": token,
                        ...
                        success: function () {
                            Swal.fire({
                                icon: 'success',
                                title: '¡Eliminado!',
                                text: 'El agente ha sido eliminado exitosamente',
                                timer: 2500,
                                didClose: () => {
                                    $(location).attr('href', window.location.origin + '/admin/database/agentes');
                                }
                            });
                        },
                        error: function (data) {
