$(document).ready(function () {
    ...
    $('body').on('click', '.edit', function () {
        var id = $(this).data('id');
        $(location).attr('href', 'edit/lloyds/' + id);
    });
                ...
                $.ajax(
                    {
                        ...
                        success: function () {
                            console.log("success");
                            $(location).attr('href', networking + '/admin/database/lloyds');
...
/*     $(document).ready(function () {
    ...
    /* ajaxSelect('#select_position', 'position', false);
    ajaxSelect('#select_contact', 'contact', false);
    ajaxSelect('#select_branch', 'branch', true); */
    //ajaxSelect('#select_insurance', 'insurance', false);
