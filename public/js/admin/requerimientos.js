$(document).ready(function() {
    ...
    /* $('.dt-add').each(function () {
    	$(this).on('click', function(evt){
    		...
    		rowData.push('<button type="button" class="btn btn-primary btn-xs dt-edit" style="margin-right:10px;"><i class="fa-solid fa-pen-to-square"></i></button><button type="button" class="btn btn-danger btn-xs dt-delete"> <i class="fa-solid fa-delete-left"></i> </button>');
