...
@section('content')
    <link rel="stylesheet" href="{{ asset('css/admin/administrativo/produccion.css') }}">
    <script src="{{ asset('js/admin/administrativo/produccion.js') }}" defer></script>
    ...
    <script>
        function updateClock() {
            ...
            const dateString = `Producción | ${day}, ${date} de ${month} del ${year} ${hour}:${minute}:${second}`;
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                              <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">CEO</button>
                            </li>
                        </ul>
