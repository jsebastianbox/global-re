    ...
    <div class="card px-4 py-2">
        <form action="{{ route('slip.update', $slip->id) }}"  enctype="multipart/form-data" method="POST" id="aviacion_2_form" >
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button" onclick="addRowObjetoSeguroV2(event, 'aviacion_licencia')"
                        ...
                        <tbody id="aviacion_licenciaObjetosTableBody">
                            @if (count($object_insurance) > 0)
                                ...
                                @foreach ($object_insurance as $key => $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <input value="{{ $item->age }}" type="number" step="any"
                                                name="age[]" class="ageInput">
                                        </td>
                                        <td style="text-align: center">
                                            <input value="{{ $item->limit }}" type="number" data-money
                                                step="any" name="limit[]">
                                        </td>
                            ...
                            @else
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <input type="date" class="birthdateInput" name="birthday[]"
                                            onchange="putAge('aviacion_licenciaTableObjetosSeguro')">
                                    </td>
                                    <td style="text-align: center">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="insuredSum">Detalle de pilotos asegurados</label>
                ...
                <div class="col-md-6">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" value="{{ $slip->limit_compensation }}" placeholder="..."
                            name="limit_compensation">
                    </div>
                </div>
            </div>
...
@else
    <form enctype="multipart/form-data" method="POST" id="aviacion_2_form" class="form aviacion2"
        style="display: none">
        ...
        <div class="tab">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button"
                                        onclick="addRowCoberturaV2(event, 'aviacion_licencia', 'aviacion', 'pl')"
                                        class="btn btn-success btn-xs">
                                        +
                                    </button>
                                </th>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button"
                                        onclick="addRowClausula(event, 'aviacion_licencia', 'aviacion', 'pl')"
                                        class="btn btn-success btn-xs">
                                        +
                                    </button>
                                </th>
            ...
            <div class="row col-md-4 mb-4" style="margin-inline: .1rem">
                <button type="button" class="btn btn-info" style="color: white"
                    onclick="addDeducible(event, 'aviacion_perdida')">Agregar deducible</button>
            </div>
