            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <label class="input-group-text" for="coverage">Detalle de bienes asegurados</label>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input type="number" step="any" placeholder="..." name="limit_compensation" data-money
                            class="form-control" value="{{ $slip->limit_compensation }}">
                    </div>
                </div>
...
@else
    <form enctype="multipart/form-data" method="POST" id="energia_form"
        class="form energia" style="display: none">
        ...
        <div class="tab">
                ...
                <div class="justify-content-center">
                    <div class="input-group col-md-5 mx-1 my-1">
                        <div class="input-group-text">
                            <input id="sumaAsegurada2" type="radio" name="sumas" onchange="chooseTypeSuma2(event)"
                    ...
                    <div class="input-group col-md-5 mx-1 my-1">
                        <div class="input-group-text">
                            <input id="sumaAsegurable2" type="radio" name="sumas"
                                onchange="chooseTypeSuma2(event)" class="form-check-input my-1">
                        </div>
                ...
                <div class="d-flex justify-content-around mb-2">
                    <div class="input-group">
                        ...
                        <button type="button" class="btn btn-info" id="btnAddColumnSumas"
                            onclick="addColumnSumas('energia1SumaAseguradaTable')">Agregar columna</button>
                    </div>

                    <button type="button" id="btnDeleteColumnSumas" class="btn btn-danger btn-xl"
                        onclick="removeColumnSumas('energia1SumaAseguradaTable')">
                        Eliminar columna
                    </button>
                </div>
                ...
                <table id="energia1SumaAseguradaTable" class="indemnizacionTable">
                    <thead>
                        ...
                        <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                            ...
                            <button type="button" onclick="addRowSumaAseguradaIncendio(event, 'energia1')"
                    ...
                    <tbody id="energia1SumaAseguradaTableBody">
                        ...
                        <tr>
                            ...
                            <td>
                                <input onkeyup="incendioSumaAsegurableTotales(1, 'energia1')" type="number"
            ...
            <div id="sumaAsegurada2Container" class="flexColumnCenterContainer"  style="display:none;margin:1.5rem 0">
                ...
                <div class="d-flex justify-content-around mb-2">
                    <div class="input-group">
                        ...
                        <button type="button" class="btn btn-info" id="btnAddColumnSumas"
                            onclick="addColumnSumas('energiaSumaAseguradaTable')">Agregar columna</button>
                    </div>

                    <button type="button" id="btnDeleteColumnSumas" class="btn btn-danger btn-xl"
                        onclick="removeColumnSumas('energiaSumaAseguradaTable')">
                        Eliminar columna
                    </button>
                </div>
                ...
                <table id="energiaSumaAseguradaTable" class="indemnizacionTable">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                ...
                                <button type="button" onclick="addRowSumaAseguradaEnergia(event, 'energia')"
                                    class="btn btn-success btn-xs">
                                    +
                                </button>
                            </th>
                    ...
                    <tbody id="energiaSumaAseguradaTableBody">
                        ...
                        <tr>
                            ...
                            <td>
                                <input onkeyup="energiaSumaAsegurableTotales('1')" type="number"
                                    name="edification[]" data-money value="0" novalidate
                                    style="width: 95px" class="edificacionInput row1">
                            </td>
                            <td>
                                <input onkeyup="energiaSumaAsegurableTotales('1')" type="number"
                                    name="contents[]" data-money value="0" novalidate
                                    style="width: 95px" class="contenidosInput row1">
                            </td>
                            <td>
                                <input onkeyup="energiaSumaAsegurableTotales('1')" type="number"
                                    name="equipment[]" data-money value="0" novalidate
                                    style="width: 95px" class="maquinariaEquiposInput row1">
                            </td>
                            <td>
                                <input onkeyup="energiaSumaAsegurableTotales('1')" type="number"
                                    name="machine[]" data-money value="0" novalidate
                                    style="width: 95px" class="mueblesInput row1">
                            </td>
                            <td>
                                <input onkeyup="energiaSumaAsegurableTotales('1')" type="number"
                                    name="commodity[]" data-money value="0" novalidate
                                    style="width: 95px" class="mercaderiasInput row1">
                            </td>
                            <td>
                                <input onkeyup="energiaSumaAsegurableTotales('1')" type="number"
                                    name="other_sum_assured[]" data-money value="0" novalidate
                                    style="width: 95px" class="otrosInput row1">
                            </td>
                            <td style="text-align: center">
            ...
            <div class="row my-3">
                <div class="col-md-4">
                    <div class="input-group">
                        <label class="input-group-text">Límite de indemnización</label>
                        <input type="number" placeholder="..." step="any" name="limit_compensation" data-money
                        class="form-control">
                    </div>
                </div>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button onclick="addRowCoberturaV2(event, 'energia', 'energia','trp')"
                                        class="btn btn-success btn-xs">
                                        +
                                    </button>
                                </th>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button" onclick="addRowClausula(event, 'energia', 'energia','all')"
                                        class="btn btn-success btn-xs">
                                        +
                                    </button>
                                </th>
        ...
        <div class="tab">
            ...
            <div class="row col-md-4 mb-4" style="margin-inline: .1rem">
                <button type="button" class="btn btn-info" style="color: white"
                    onclick="addDeducible(event, 'energia')">Agregar deducible</button>
            </div>
