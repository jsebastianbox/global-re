...
<div class="row mb-3">
    <div class="col-md-4">
        <div class="input-group mb-3">
            ...
            <select required class="js-example-basic-single inputForm select_country form-select" name="country_id" onchange="countryLeyJurisdiccion()">
...
<div class="row mb-3">
    ...
    <div class="col-md-4">
        <div class="input-group mb-3">
            ...
            <input type="number" step="any" name="equivalence" id="equivalence" placeholder="$" class="form-control" value="{{ $slip->equivalence }}">
        </div>
    </div>
    <div class="col-md-4">
        <div class="input-group mb-3">
...
<div class="row mb-1">
    <div class="col-md-4">
        <div class="input-group mb-3">
            ...
            <input type="text" name="retrocedente" id="retrocedente" class="form-control" value="{{ $slip->retrocedente }}">
        </div>
    </div>
    <div class="col-md-4">
        <div class="input-group mb-3">
    ...
    <div class="row">
        <div class="col-md-3 my-1">
            <div class="input-group">
                ...
                <input type="date" min="" id="validity_since" name="validity_since" value="{{ $slip->validity_since }}" class="form-control">
            </div>
        </div>
        <div class="col-md-3 my-1">
            <div class="input-group">
                ...
                <input type="date" id="validity_until" name="validity_until" value="{{ $slip->validity_until }}" class="form-control">
            </div>
        </div>
    </div>
</div>
...
<div class="col-md-4 my-3" @if($slip->type_coverage === 11 || $slip->type_coverage === 12 || $slip->type_coverage === 13 || $slip->type_coverage === 14 || $slip->type_coverage === 15 || $slip->type_coverage === 16 || $slip->type_coverage === 17 || $slip->type_coverage === 18 || $slip->type_coverage === 19 || $slip->type_coverage === 20)
    style="display:none;"
    ...
    <div class="input-group mb-3">
        ...
        <select class="js-example-basic-single inputForm select_assigned form-select" name="user_id">
            <option selected value="{{ $users->find($slip->user_id)->id }}">
                {{ $users->find($slip->user_id)->name . ' ' . $users->find($slip->user_id)->surname }}
            </option>
        </select>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-md-4">
        <div class="input-group mb-3">
            ...
            <input type="number" step="any" name="equivalence" id="equivalence" placeholder="$" class="form-control">
        </div>
    </div>
    <div class="col-md-4">
        <div class="input-group mb-3">
    ...
    <div class="row">
        <div class="col-md-3 my-1">
            <div class="input-group">
                <label class="input-group-text" for="validity_since">
                    <i class="fa-solid fa-calendar-check"></i>&nbsp;Desde</label>
                <input type="date" id="validity_since" name="validity_since" value="{{ date('Y-m-d') }}" class="form-control">
            </div>
        </div>
        <div class="col-md-3 my-1">
            <div class="input-group">
                <label class="input-group-text" for="validity_until">
                    <i class="fa-solid fa-calendar-check"></i>&nbsp;Hasta</label>
                <input type="date" id="validity_until" name="validity_until" value="{{ date('Y-m-d', strtotime('+1 year')) }}" class="form-control">
            </div>
        </div>
    </div>
</div>
...
<div class="row mt-3">
    ...
    <div class="col-md-4 my-3">
        <div class="input-group mb-3" id="coberturaContainer">
            <label class="input-group-text" for="coverage">Cobertura</label>
            <textarea name="coverage" id="coverage" style="resize:both;width:100%;" cols="30" rows="1" class="form-control"></textarea>
        </div>
    </div>
