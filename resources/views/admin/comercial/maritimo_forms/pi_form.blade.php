...
margin-top: 1.3rem;
    ...
    <div class="card" style="padding-inline: 1rem; padding-block: 1.75rem">
        <form enctype="multipart/form-data" method="POST"   id="maritimo_2_form"
            onsubmit="maritimoform2()">
            @csrf
            @method('PUT')
            ...
            <div class="row my-3">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input type="number" step="any" placeholder="..." name="limit_compensation" id="limit"
                            data-money value="{{ $slip->limit_compensation }}">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <textarea name="coverage" id="coverage" style="resize:both;width:100%;" 
                        cols="30" rows="1">{{ !empty($slip->coverage) ? $slip->coverage : '' }}</textarea>
                </div>
...
@else
    <form enctype="multipart/form-data" method="POST"   id="maritimo_2_form"
        class="form maritimo2" onsubmit="maritimoform2()" style="display: none">
        ...
        <div class="tab">
            ...
            <div class="row">
                <div class="tableContainer">
                    <table id="maritimo_piTableEmbarcaciones" class="indemnizacionTable bigTable"
                        style="margin: 1.5rem 0">
                        <thead>
                            <tr>
                                <th style="text-align: center">#</th>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button" onclick="addRowEmbarcaciones(event, 'maritimo_pi')"
                                        class="btn btn-success btn-xs">
                                        +
                                    </button>
                                </th>
                        ...
                        <tbody id="maritimo_piTableEmbarcacionesBody">
                            <tr>
                                ...
                                <td>
                                    <input onkeyup="sumaCascoMaquina(1, 1, 'maritimo_pi')" type="number"
                                        data-money step="any" class="row1 col1" name="shell_boat[]"
                                        value="0">
                                </td>
                                <td>
                                    <input onkeyup="sumaCascoMaquina(1, 2, 'maritimo_pi')" type="number"
                            ...
                            <tr>
                                ...
                                <td>
                                    <input onkeyup="sumaCascoMaquina(2, 1, 'maritimo_pi')" type="number"
                                        data-money step="any" class="row2 col1" name="shell_boat[]"
                                        value="0">
                                </td>
                                <td>
                                    <input onkeyup="sumaCascoMaquina(2, 2, 'maritimo_pi')" type="number"
        ...
        <div class="tab">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button" onclick="addRowCoberturaV2(event, 'maritimo_proteccion')"
                                        class="btn btn-success btn-xs">
                                        +
                                    </button>
                                </th>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button" onclick="addRowClausula(event, 'maritimo_proteccion')"
                                        class="btn btn-success btn-xs">
                                        +
                                    </button>
                                </th>
            ...
            <div class="row col-md-4 mb-4" style="margin-inline: .1rem">
                <button type="button" class="btn btn-info" style="color: white"
                    onclick="addDeducible(event, 'proteccion')">Agregar deducible</button>
            </div>
        </div>
        <div class="tab">
