...
@else
    <form enctype="multipart/form-data" method="POST"   id="maritimo_3_form"
        class="form maritimo3" style="display: none">
        ...
        <div class="tab">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button" onclick="addRowCoberturaV2(event, 'maritimo_rc')"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button" onclick="addRowClausula(event, 'maritimo_rc')"
                                        class="btn btn-success btn-xs">
                                        +
                                    </button>
                                </th>
            ...
            <div class="row col-md-4 mb-4" style="margin-inline: .1rem">
                <button type="button" class="btn btn-info" style="color: white"
                    onclick="addDeducible(event, 'maritimo_rc')">Agregar deducible</button>
            </div>
