            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select name="type_merchandise" id="claseMercancia">
                        ...
                        <option {{ $slip_type->type_merchandise == 'semovientes' ? 'selected' : '' }}
                            value="semovientes">Semovientes</option>
                ...
                <div class="col-md-6">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="status_transport" id="transportStatus"
                            value="{{ $slip_type->status_transport }}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="insured_journey" id="transportStatus"
                            value="{{ $slip_type->insured_journey }}">
                    </div>
                </div>
...
@else
    <form enctype="multipart/form-data" method="POST"   id="maritimo_4_form"
        class="form transporte" style="display: none">
        ...
        <div class="tab">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <label class="input-group-text" for="anualCost">Estimado de movilización anual</label>
                        <input type="number" step="any" name="annual_mobilization" id="anualCost"
                            data-money>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <input type="date" id="departure" name="departure_date" value="2022-07-01" min="1950-07-30"
                            max="2096-07-30">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <input type="date" id="arrival" name="arrival_date" value="2022-07-01" min="1950-07-30"
                            max="2096-07-30">
                    </div>
                </div>
            </div>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button" onclick="addRowCoberturaV2(event, 'maritimo_transporte')"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button" onclick="addRowClausula(event, 'maritimo_transporte')"
                                        class="btn btn-success btn-xs">
                                        +
                                    </button>
                                </th>
            ...
            <div class="row col-md-4 mb-4" style="margin-inline: .1rem">
                <button type="button" class="btn btn-info" style="color: white"
                    onclick="addDeducible(event, 'transporte_maritimo')">Agregar deducible</button>
            </div>
