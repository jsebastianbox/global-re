...
<div class="card" style="padding-inline: 1rem; padding-block: 1.75rem">
    <form enctype="multipart/form-data" method="POST" action="{{ route('slip.update', $slip->id) }}" id="responsabilidad_form">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="number" step="any" id="" name="limit_event" placeholder="USD" value="{{ $slip_type->limit_event }}" data-money>
                </div>
            </div>
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="number" step="any" id="" name="limit_annual" placeholder="USD" data-money value="{{ $slip_type->limit_annual}}" />
                </div>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                <div class="input-group">
                    ...
                    <input type="number" step="any" name="ingress_previous_year" id="pastYearIncome" value="{{ $slip_type->ingress_previous_year }}" data-money>
                </div>
            </div>
            <div class="col-md-4">
                <div class="input-group">
            ...
            <div class="col-md-4">
                <div class="input-group">
                    <label class="input-group-text" for="estimatedIncomenextYear">Ingreso estimado del próximo
                        año</label>
                    <input type="number" step="any" name="ingress_next_year" id="estimatedIncomenextYear" value="{{ $slip_type->ingress_next_year }}" data-money>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                @if ($accidentRate)
                <a download="siniestralidad_previa" style="padding:1rem; color: #000" id="accidentRateDownload">Siniestralidad de los últimos 5 años - Previa</a>
...
@else
<form enctype="multipart/form-data" method="POST" id="responsabilidad_form" class="form responsabilidad" style="display: none">
    ...
    <div class="tab">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="number" step="any" id="" name="limit_event" placeholder="USD" data-money>
                </div>
            </div>
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="number" step="any" id="" name="limit_annual" placeholder="USD" data-money>
                </div>
            </div>
        </div>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1" colspan="1" aria-label="Add row">
                                ...
                                <button type="button" onclick="addRowCoberturaV2(event, 'responsabilidad', 'responsabilidad_civil', 'all')" class="btn btn-success btn-xs">
                                    +
                                </button>
                            </th>
                        </tr>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1" colspan="1" aria-label="Add row">
                                ...
                                <button type="button" onclick="addRowClausula(event, 'responsabilidad', 'responsabilidad_civil', 'extracontractual')" class="btn btn-success btn-xs">
                                    +
                                </button>
                            </th>
                        </tr>
        ...
        <div class="row col-md-4 mb-4" style="margin-inline: .1rem">
            <button type="button" class="btn btn-info" style="color: white" onclick="addDeducible(event, 'responsabilidad_form')">Agregar deducible</button>
        </div>
    ...
    <div class="tab">
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                <div class="input-group">
                    <label class="input-group-text" for="pastYearIncome">Ingreso bruto del año anterior</label>
                    <input type="number" step="any" name="ingress_previous_year" id="pastYearIncome" data-money>
                </div>
            </div>
            <div class="col-md-4">
                <div class="input-group">
            ...
            <div class="col-md-4">
                <div class="input-group">
                    <label class="input-group-text" for="estimatedIncomenextYear">Ingreso estimado del próximo
                        año</label>
                    <input type="number" step="any" name="ingress_next_year" id="estimatedIncomenextYear" data-money>
                </div>
            </div>
        </div>
