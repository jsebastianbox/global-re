...
@else
    <form enctype="multipart/form-data" method="POST"   id="riesgos_form"
        class="form riesgos" style="display: none">
        ...
        <div class="tab">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button" onclick="addRowCoberturaV2(event, 'riesgos', 'responsabilidad_civil', 'extracontractual')"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button" onclick="addRowClausula(event, 'riesgos', 'responsabilidad_civil', 'extracontractual')"
                                        class="btn btn-success btn-xs">
                                        +
                                    </button>
                                </th>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="reinsurer_rate">Tasa de reaseguros</label>
                        <input class="inputForm" type="number" name="reinsurer_rate" step="any" id="reinsurer_rate"><span
                            class="input-group-text">%</span>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="deducible">Prima de reaseguros</label>
                        <input class="inputForm" type="number" placeholder="USD" step="any" name="reinsurance_premium"
                            data-money>
                    </div>
                </div>
            </div>
            ...
            <div class="row col-md-4 mb-4" style="margin-inline: .1rem">
                <button type="button" class="btn btn-info" style="color: white"
                    onclick="addDeducible(event, 'riesgos')">Agregar deducible</button>
            </div>
        </div>
