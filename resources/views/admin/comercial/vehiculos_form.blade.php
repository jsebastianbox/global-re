...
@if (\Illuminate\Support\Str::contains(\Illuminate\Support\Facades\Request::url(), '/admin/comercial/edit_compromiso/'))
    ...
    <div class="card">
        <form enctype="multipart/form-data" method="POST" action="{{ route('slip.update', $slip->id) }}"
            id="vehiculoslp" style="padding-block: 1rem; padding-inline: 2rem">
...
@else
    <form enctype="multipart/form-data" method="POST" id="vehiculoslp" class="form vehiculos"
        style="display: none">
        <!-- One "tab" for each step in the form: -->
        ...
        <div class="tab">
            ...
            <div class="row">
                <div class="tableContainer" style="margin: 2rem 0">
                    <table id="vehiculosCoberturasAdicionalesTable" name="vehiculosCoberturasAdicionalesTable"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button" onclick="addRowCoberturaV2(event, 'vehiculos', 'tecnico', 'vehiculos')"
            ...
            <div class="row">
                <div class="tableContainer" style="margin: 2rem 0">
                    <table id="vehiculosClausulasAdicionalesTable" name="vehiculosClausulasAdicionalesTable"
                        class="indemnizacionTable">
                        <thead>
                            <tr>
                                <th style="text-align: center; width: 42px;">#</th>
                                ...
                                <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1"
                                    ...
                                    <button type="button" onclick="addRowClausula(event, 'vehiculos', 'tecnico', 'vehiculos')"
                                        class="btn btn-success btn-xs">
                                        +
                                    </button>
                                </th>
        ...
        <div class="tab">
            ...
            <div class="row col-md-4 mb-4" style="margin-inline: .1rem">
                <button type="button" class="btn btn-info" style="color: white"
                    onclick="addDeducible(event, 'vehiculos')">Agregar deducible</button>
            </div>
