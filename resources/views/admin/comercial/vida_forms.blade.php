    ...
    <form method="POST" action="{{ route('slip.update', $slip->id) }}" id="vida_form" enctype="multipart/form-data">
                ...
                <table id="vidaListadoPersonasAseguradasTable" class="indemnizacionTable">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1" colspan="1" aria-label="Add row">
                                ...
                                <button type="button" onclick="addPersonaAseguradaRow(event, 'vida')" class="btn btn-success btn-xs">
                                    +
                                </button>
                            </th>
                        </tr>
                    ...
                    <tbody id="vidaListadoPersonasAseguradasTableBody">
                        ...
                        <tr>
                            ...
                            <td>
                                <input value="{{$item->age}}" type="number" class="ageInput" name="age[]" id="personAge" min="1" max="110">
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" class="ageInput" name="age[]" id="personAge" min="1" max="110">
                            </td>
        ...
        <div>
            <div style="float:right;" class="row">
                <div class="input-group mb-3">
                    <div class="col-md">
                        <button type="submit" id="submitBtn" class="btn btn-info mx-2" style="color: white">Enviar al dpto. Técnico</button>
                    </div>
                </div>
            </div>
    </form>
...
@else
<form method="POST" id="vida_form" class="form vida" style="display: none" enctype="multipart/form-data">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1" colspan="1" aria-label="Add row">
                                ...
                                <button type="button" onclick="addRowCoberturaV2(event, 'vida_forms', 'vida', 'vida')" class="btn btn-success btn-xs">
                                    +
                                </button>
                            </th>
                        </tr>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1" colspan="1" aria-label="Add row">
                                ...
                                <button type="button" onclick="addRowClausula(event, 'vida', 'vida', 'vida')" class="btn btn-success btn-xs">
                                    +
                                </button>
                            </th>
                        </tr>
    ...
    <div class="tab">
        ...
        <div class="row col-md-4 mb-4" style="margin-inline: .1rem">
            <button type="button" class="btn btn-info" style="color: white" onclick="addDeducible(event, 'vida')">Agregar deducible</button>
        </div>
    </div>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center; width: 42px;" class="sorting_disabled" rowspan="1" colspan="1" aria-label="Add row">
                                ...
                                <button type="button" onclick="addPersonaAseguradaRow(event, 'vida')" id="btnAddPersonaAsegurada" class="btn btn-success btn-xs" style="display: none">
                                    +
                                </button>
                            </th>
                        </tr>
