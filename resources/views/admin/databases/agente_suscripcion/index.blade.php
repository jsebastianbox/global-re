...
@section('tab_title')
    ...
    <script>
        function updateClock() {
            ...
            const dateString =
                `Agentes de Suscripción | ${day}, ${date} de ${month} del ${year} ${hour}:${minute}:${second}`;
...
@if (session('success'))
    <script>
        ...
        Swal.fire({
            ...
            willClose: () => {
                window.location.href = '/admin/database/agentes';
            }
        });
    </script>
@endif
...
<div class="card text-left">
    ...
    <div class="card-header">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('agentes.index') }}><i class="fa-solid fa-house"></i> Inicio</a>
            </li>
            <li class="nav-item">
...
<script src="{{ asset('js/admin/database/agente.js') }}" defer></script>
