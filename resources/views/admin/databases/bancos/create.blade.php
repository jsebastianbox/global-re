...
@section('tab_title')
    ...
    <script>
        function updateClock() {
            ...
            const dateString = `Agregar Banco | ${day}, ${date} de ${month} del ${year} ${hour}:${minute}:${second}`;
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('bancos.store') }}">
            ...
            <div class="card-body" style="padding-block: 2rem"></div>
