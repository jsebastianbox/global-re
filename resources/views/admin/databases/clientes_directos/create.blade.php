...
@section('tab_title')
    ...
    <script>
        function updateClock() {
            ...
            const dateString = `Agregar Cliente Directo | ${day}, ${date} de ${month} del ${year} ${hour}:${minute}:${second}`;
...
<div class="card">
    <div class="card-header">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('clientes_directos.index') }}"><i class="fa-solid fa-house"></i> Inicio</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('clientes_directos.create') }}"> <i class="fa-solid fa-plus"></i> Crear</a>
            </li>
        </ul>
    </div>
    ...
    <form method="POST" action="{{ route('clientes_directos.store') }}">
        @csrf
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="ri_bq">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-group">
