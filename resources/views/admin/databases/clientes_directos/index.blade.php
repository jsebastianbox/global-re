...
@endsection
@section('page_title')
Bases de Datos | Clientes Directos
@endsection
...
<div class="card text-left">
    ...
    <div class="card-header">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('clientes_directos.index') }}"><i class="fa-solid fa-house"></i> Inicio</a>
            </li>
            <li class="nav-item">
    ...
    <div class="card-body">
        ...
        <table id="example" class="table table-striped" style="width:100%">
            <thead>
                <tr>
                    <th scope="col">Reasegurador/Broker</th>
                    <th scope="col">Ref</th>
