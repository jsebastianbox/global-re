...
@section('tab_title')
    ...
    <script>
        function updateClock() {
            ...
            const dateString =
                `Editar Lloyds | ${day}, ${date} de ${month} del ${year} ${hour}:${minute}:${second}`;
...
<div class="card">
    <div class="card-header">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('lloyds.index') }}"><i class="fa-solid fa-house"></i> Inicio</a>
            </li>
            <li class="nav-item">
    ...
    <form method="POST" action="{{ route('lloyds.update', ['id' => $lloyds->id]) }}">
        @csrf
        @method('PUT')
        <input type="hidden" name="id" value="{{ $lloyds->id }}">
        ...
        <div class="card-body" style="padding-block: 2rem">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="name" value="{{ $lloyds->name }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <select id="select_country" class="js-example-basic-single form-select" name="country_id">
                                <option value="{{ $lloyds->country_id }}" selected="selected">
                                    @if (is_numeric($lloyds->country_id))
                                        {{ DB::table('countries')->select('name')->where('id', $lloyds->country_id)->first()->name }}
                                    @else
                                        {{ $lloyds->country_id }}
                                    @endif
                                </option>
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <select id="select_position" class="js-example-basic-single form-select" name="position_id">
                                <option value="{{ $lloyds->position_id }}" selected="selected">
                                        {{ $lloyds->position_id }}
                                </option>
                            </select>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input type="text" disabled class="form-control" value="Lloyds" name="reference">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <select id="select_contact" class="js-example-basic-single inputForm" name="contact_id">
                                <option value="{{ $lloyds->contact_id }}" selected="selected">
                                    {{ $lloyds->contact_id }}</option>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control" name="email" value="{{ $lloyds->email }}">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <select id="select_region" class="js-example-basic-single form-select" name="region_id">
                                <option value="{{ $lloyds->region_id }}">{{ $lloyds->region_id }}</option>
                            </select>
            ...
            <div class="row">
                ...
                <div class="text-center my-4">
                    <a href="javascript:void(0)" data-id="{{ $lloyds->id }}"
...
<script src="{{ asset('js/admin/database/lloyds.js') }}"></script>
