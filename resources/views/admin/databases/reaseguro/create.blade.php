...
@section('tab_title')
    ...
    <script>
        function updateClock() {
            ...
            const dateString =
                `Agregar Compañía de Reaseguradores | ${day}, ${date} de ${month} del ${year} ${hour}:${minute}:${second}`;
...
@endsection
@section('page_title')
    Administración | Compañía de Reaseguradores
@endsection
...
<div class="card">
    ...
    <form method="POST" action="{{ route('reinsurer.store') }}">
        @csrf
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input type="text" disabled class="form-control" value="RI" name="reference">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-group">
...
<script src="{{ asset('js/admin/comercial/ajax.js') }}"></script>
