...
@section('content')
    <link rel="stylesheet" href="{{ asset('css/admin/siniestros/ajustadores.css') }}">
    <script src="{{ asset('js/admin/apertura.js') }}" defer></script>
@section('tab_title')
    <div id="date"></div>
    <script>
        function updateClock() {
            ...
            const dateString = `Siniestros — Apertura | ${day}, ${date} de ${month} del ${year} ${hour}:${minute}:${second}`;
