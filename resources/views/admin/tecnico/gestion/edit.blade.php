...
<link rel="stylesheet" href="{{ asset('css/admin/administrativo/usuarios.css') }}">
    ...
    <script>
        function updateClock() {
            ...
            const dateString = `Técnico — Editar Gestor de Reaseguros | ${day}, ${date} de ${month} del ${year} ${hour}:${minute}:${second}`;
                    ...
                    <table id="example" class="table table-striped table-bordered dataTable no-footer" cellspacing="0"
                        ...
                        <tbody id="newObject">
                            <tr>
                                ...
                                <th>
                                    <input type="text" id="country" name="country" value="Daniel Dagnino">
                                </th>
                                <th>
                                    <input type="text" id="country" name="country" value="30">
                                </th>
                                <th>
                                    <select name="" id="">
                                ...
                                <th>
                                    <input type="text" id="country" name="country" value="No RC contractual">
                                </th>
                                {{-- <th>
                            ...
                            <tr>
                                <th>
                                    <select name="" id="">
                                        <option value="" >AIG _ American International Group</option>
                                        <option value="">Allianz Global Corporate & Specialty Re</option>
                                        <option value="">Austral Resseguradora S.A.</option>
                                        <option value="" selected >Axa Xl Insurance Company Uk Limited</option>
                                        <option value="">Beazley Group</option>
                                        <option value="">Berkley Insurance Company</option>
                                    </select>
                                </th>
                                <th>
                                    <input type="text" id="country" name="country" value="Oscar Rodriguez">
                                </th>
                                <th>
                                    <input type="text" id="country" name="country" value="70">
                                </th>
                                <th>
                                    <select name="" id="">
                                        <option value="">AG</option>
                                        <option value="">RC</option>
                                        <option value="" selected >BQ</option>
                                        <option value="">RI</option>
                                    </select>
                                </th>
                                <th>
                                    <input type="text" id="country" name="country" value="Cotizando">
                                </th>
                                {{-- <th>
                                        <button type="button" class="btn btn-danger btn-xs dt-delete"><span
                                                class="glyphicon glyphicon-remove" aria-hidden="false"></span></button>
