<form method="POST" action="{{ route('slip.update',$slip->id) }}" enctype="multipart/form-data" id="formSlipArmadores"
    class="new_entry__form" >

    @method('PUT');

    @csrf
    <input type="hidden" name="type_slip" value="armador">


    <div class="form_group1">
        <h3 class="slipTitle"> <span class="badge badge-secondary">1</span> Slip Responsabilidad Civil Armadores</h3>
        ...
        <div class="two-sides" style="width: 100%">
            ...
            <div class="left_side">
                ...
                <div class="input_group">
                    <label for="armadoresObjetoSeguro">
 ...
 cols="30" rows="1"></textarea>
            ...
            <div class="right_side">
                ...
                <div class="input_group">
                    <label for="armadoresLimiteIndem">
                        <i class="fa-solid fa-bars-staggered"></i>
                        Limite de indemnizacion:
                    </label>
                    <input type="number" id="armadoresLimiteIndem" name="limit_compensation" placeholder="numérico.." disabled>
                </div>
