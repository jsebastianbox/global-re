<form method="POST" action="{{ route('slip.update', $slip->id) }}"  enctype="multipart/form-data" id="formSlipExportaciones"
    class="new_entry__form" >
    @method('PUT');

    @csrf
    <input type="hidden" name="type_slip" value="trans_export">

    <div class="form_group1">
        <h3 class="slipTitle"> <span class="badge badge-secondary">1</span> Slip Transporte Exportaciones</h3>
        ...
        <div class="two-sides">
            <div class="left_side">
                ...
                <div class="input_group">
                    <label for="exportacionesObjetoSeguro">
                ...
                {{-- Trayecto asegurado --}}
                <div class="input_group">
                    <label for="exportacionesTrayectoAsegurado">
                        <i class="fa-solid fa-bars-staggered"></i>
                        Trayecto asegurado:
                    </label>
                    <input type="text" id="exportacionesTrayectoAsegurado" name="insured_journey"
                        placeholder="...">
                </div>
                {{-- Clase de mercancía --}}
                <div class="input_group">
                    <label for="exportacionesClase">
                        <i class="fa-solid fa-bars-staggered"></i>
                        Clase de mercancía:
                    </label>
                    <select name="type_merchandise" id="exportacionesClase">
                ...
                {{-- Tipo de embalaje --}}
                <div class="input_group">
                    <label for="exportacionesTipoEmbalaje">
                        <i class="fa-solid fa-bars-staggered"></i>
                        Tipo de embalaje:
                    </label>
                    <select name="type_packing" id="exportacionesTipoEmbalaje">
                        <option value="0" selected>Selecciona</option>
                ...
                {{-- Tipo de unificador --}}
                <div class="input_group">
                    <label for="exportacionesTipoUnificador">
                        <i class="fa-solid fa-bars-staggered"></i>
                        Tipo de unificador:
                    </label>
                    <select name="type_unify" id="exportacionesTipoUnificador">
                        <option value="0" selected>Selecciona</option>
                ...
                {{-- Medio de transporte --}}
                <div class="input_group">
                    <label for="exportacionesMedioTransporte">
                        <i class="fa-solid fa-bars-staggered"></i>
                        Medio de transporte:
                    </label>
                    <select name="transportation" id="exportacionesMedioTransporte">
                        <option value="0" selected>Selecciona</option>
            ...
            <div class="right_side">
                ...
                <div class="input_group">
                    <label for="exportacionesMovilizacion">
                        <i class="fa-solid fa-bars-staggered"></i>
                        Estimado de movilización anual:
                    </label>
                    <input type="number" id="exportacionesMovilizacion" name="annual_mobilization"
                        placeholder="0">
                </div>
                {{-- Límite por embarque --}}
                <div class="input_group">
                    <label for="exportacionesLimiteEmbarque">
                        <i class="fa-solid fa-bars-staggered"></i>
                        Límite por embarque:
                    </label>
                    <input type="number" id="exportacionesLimiteEmbarque" name="limit_shipment"
                        placeholder="0">
                </div>
                {{-- Fecha aproximada de salida --}}
                <div class="input_group">
                    <label for="exportacionesFechaSalida">
                        <i class="fa-solid fa-bars-staggered"></i>
                        Fecha aproximada de salida:
                    </label>
                    <input type="number" id="exportacionesFechaSalida" name="departure_date" placeholder="0">
                </div>
                {{-- Fecha aproximada de llegada --}}
                <div class="input_group">
                    <label for="exportacionesFechaLlegada">
                        <i class="fa-solid fa-bars-staggered"></i>
                        Fecha aproximada de llegada:
                    </label>
                    <input type="number" id="exportacionesFechaLlegada" name="arrival_date"
                        placeholder="0">
                </div>
                {{-- Cobertura --}}
                <div class="input_group">
                    <label for="exportacionesCobertura">
                        <i class="fa-solid fa-bars-staggered"></i>
                        Cobertura:
                    </label>
